...
echo "=== Building Orchestra AppImage (${ARCH}) using electron-builder ==="
if [ "$UPLOAD" = true ]; then
...
# electron-builder outputs: Orchestra-x86_64.AppImage or Orchestra-aarch64.AppImage
BUILT_APPIMAGE_NAME="Orchestra-${LINUX_ARCH}.AppImage"
...
# Rename to our standard naming convention: Orchestra-x64.AppImage, Orchestra-arm64.AppImage
APPIMAGE_NAME="Orchestra-${ARCH}.AppImage"
