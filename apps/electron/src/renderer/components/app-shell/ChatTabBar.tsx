...
export function ChatTabBar({ tabs, activeTabId, onActivate, onClose }: ChatTabBarProps) {
  const shouldCompensate = useCompensateForStoplight()

  return (
    <div
      className={cn(
        'flex shrink-0 items-end gap-0 h-[36px] overflow-x-auto overflow-y-hidden',
    ...
    >
      ...
      <button
        className={cn(
          'flex items-center justify-center h-[34px] w-[34px] shrink-0',
