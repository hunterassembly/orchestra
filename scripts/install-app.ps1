...
$process = Get-Process -Name "Orchestra" -ErrorAction SilentlyContinue
if ($process) {
    Write-Info "Closing Orchestra..."
...
$binDir = "$env:LOCALAPPDATA\Orchestra\bin"
$cmdFile = "$binDir\craft-agents.cmd"
$exePath = "$env:LOCALAPPDATA\Programs\Orchestra\Orchestra.exe"
...
Write-Host ""
Write-Host "  Orchestra has been installed."
Write-Host ""
